...
public class Main {
    public static void main(String[] args) {
        SudokuBoard sudokuBoard1 = new SudokuBoard(9, new int[][]{
                {3,0,2,0,5,0,6,0,0},
                {0,0,0,0,0,3,0,0,0},
                {1,0,0,0,0,9,5,0,0},
                {8,0,0,0,0,0,0,9,0},
...
//        SudokuBoard sudokuBoard = sudokuBoardGenerator.getSudokuBoard();
        SudokuBoard sudokuBoard = new SudokuBoardReader("src/main/resources/sudoku.board").getSudokuBoardFromFile();
